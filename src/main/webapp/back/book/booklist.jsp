        ...
        $("#books").datagrid({
            ...
            columns:[[
                ...
                {title:"操作",field:"option",width:400,
                    formatter: function(value,row,index){
                        return "<a class='del' data-options=\"plain:true,iconCls:'icon-20130408025545236_easyicon_net_30'\" onclick=\"deleteBook('" + row.id + "')\">[删除]</a><a class='update'  data-options=\"plain:true,iconCls:'icon-edit',\" onclick=\"updateBookDialog('" + row.id + "')\">[修改]</a><a class='detail'  data-options=\"plain:true,iconCls:'icon-edit',\" onclick=\"detailDialog('" + row.id + "')\">[详情]</a>";
                    }
                }
            ]],
