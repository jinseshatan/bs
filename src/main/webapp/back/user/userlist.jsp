    ...
    $(function () {
        $("#users").datagrid({
            ...
            columns: [[
                ...
                {title: "账号", field: "accountNumber", width: 200},
                {title: "密码", field: "password", width: 100},
                {title: "头像", field: "photo", width: 200},
                {title: "已读图书", field: "inreadcount", width: 150},
                {title: "未读图书", field: "outreadcount", width: 200},
                {title: "用户状态", field: "userSatus", width: 200},
                {title: "注册时间", field: "registerdate", width: 150},
                {title: "书架ID", field: "rackId", width: 200},
                {title: "生日", field: "bir", width: 200},
                {title: "盐", field: "salt", width: 200},
                {
                    title: "操作", field: "option", width: 400,
                    formatter: function (value, row, index) {
                        return "<a class='del' data-options=\"plain:true,iconCls:'icon-20130408025545236_easyicon_net_30'\" onclick=\"deleteUser('" + row.id + "')\">[冻结]</a><a class='del' data-options=\"plain:true,iconCls:'icon-20130408025545236_easyicon_net_30'\" onclick=\"activeUser('" + row.id + "')\">[激活]</a>";
                    }
                }
            ]],
